...
class Account(Base):
    ...
    # Wallet Private Key (Phase 3: KISS Wallet Integration)
    wallet_private_key_encrypted = Column(String(500), nullable=True)  # Encrypted private key for automated trading
